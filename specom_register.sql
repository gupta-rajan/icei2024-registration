...
CREATE TABLE `register_info` (
  ...
  `country_cat` varchar(50) NOT NULL,
...
(1, 'SAARC Country Full Registration with Satellite Workshop@Goa', 0, 9024, 11682, 0, 0, 1),
(2, 'SAARC Country Participant with Satellite Workshop@Goa', 0, 7552, 9558, 0, 0, 0),
(3, 'SAARC Country Student Full Registration with Satellite Workshop@Goa', 0, 8378, 10856, 0, 0, 1),
(4, 'SAARC Country Student Participant with Satellite Workshop@Goa', 0, 6726, 8378, 0, 0, 0),
(5, 'SAARC Country Full Registration light* (Without Workshop)', 0, 6608, 8378, 0, 0, 1),
(6, 'SAARC Country Participant light* (Without Workshop)', 0, 5074, 6254, 0, 0, 0),
(7, 'SAARC Country Student Full Registration light* (Without Workshop)', 0, 5900, 7670, 0, 0, 1),
(8, 'SAARC Country Student Participant light* (Without Workshop)', 0, 4248, 5074, 0, 0, 0),
(9, 'Other Country Full Registration with Satellite Workshop@Goa', 1, 25252, 28084, 22727, 25276, 1),
(10, 'Other Country Participant with Satellite Workshop@Goa', 1, 13806, 15812, 12426, 14231, 0),
(11, 'Other Country Student Full Registration with Satellite Workshop@Goa', 1, 19116, 21948, 17205, 19754, 1),
(12, 'Other Country Student Participant with Satellite Workshop@Goa', 1, 10856, 12626, 9771, 11364, 0),
(13, 'Other Country Full Registration light* (Without Workshop)', 1, 22774, 24780, 20497, 22302, 1),
(14, 'Other Country Participant light* (Without Workshop)', 1, 11210, 12508, 10089, 11258, 0),
(15, 'Other Country Student Full Registration light* (Without Workshop)', 1, 16520, 18644, 14868, 16780, 1),
(16, 'Other Country Student Participant light* (Without Workshop)', 1, 8378, 9204, 7541, 8284, 0),
(17, 'Workshop@Goa only', 1, 2596, 3304, 2596, 3304, 0),
(18, 'Workshop@Goa only', 0, 2596, 3304, 2596, 3304, 0);
